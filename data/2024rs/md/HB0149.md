...
~~[is~~ ~~notified,]~~(b) Except for a minor patient, unless a patient ~~PROVIDES~~ ~~WRITTEN~~
~~AUTHORIZATION~~ ~~IN~~ ~~RESPONSE~~ ~~TO~~ ~~A~~ ~~REQUEST~~ ~~TO~~ ~~DESTROY~~ ~~A~~ ~~RECORD~~ ~~OR~~ ~~REPORT~~
provider,a health care may not destroy a medical~~FROM~~ ~~THE~~ ~~HEALTH~~ ~~CARE~~ ~~PROVIDER~~
[5] ~~10~~ 7record or laboratory or X–ray report about a patient for years after the record or
report is made.
...
[3 later] ~~10~~ 7plus years or for 5 years after the record or report is made, whichever is
YEARS, unless:

~~[is~~ ~~notified]~~(1) The parent or guardian of the minor patient ~~PROVIDES~~
~~WRITTEN~~ ~~AUTHORIZATION~~ ~~IN~~ ~~RESPONSE~~ ~~TO~~ ~~A~~ ~~REQUEST~~ ~~FROM~~ ~~A~~ ~~HEALTH~~ ~~CARE~~
~~REPORT;~~ or~~PROVIDER~~ ~~TO~~ ~~DESTROY~~ ~~THE~~ ~~RECORD~~ ~~OR~~

(2) If the medical care documented in the record was provided under §
~~[is~~ ~~notified]~~20–102(c) or § 20–103(c) of this article, the minor patient ~~PROVIDES~~ ~~WRITTEN~~
~~AUTHORIZATION~~ ~~IN~~ ~~RESPONSE~~ ~~TO~~ ~~A~~ ~~REQUEST~~ ~~FROM~~ ~~A~~ ~~HEALTH~~ ~~CARE~~ ~~PROVIDER~~ ~~TO~~
~~RECORD.~~~~DESTROY~~ ~~THE~~

~~[The~~ ~~notice]~~ ~~A~~ [subsections] [and](d) under (b)~~REQUEST~~ ~~MADE~~ SUBSECTION
(c) of this section shall:OR

~~first–class:~~(1) Be made by

(I) FIRST–CLASS mail to the last known address of the patient;
AND

(II) E–MAIL E–MAIL OF:TO THE LAST KNOWN ADDRESS

1. THE PATIENT; OR

2. IF THE PATIENT IS A MINOR AND THE MEDICAL CARE
§ 20–102(C) §DOCUMENTED IN THE RECORD WAS NOT PROVIDED UNDER OR
20–103(C) ARTICLE, PATIENT;OF THIS THE PARENT OR GUARDIAN OF THE
...
~~[shall]~~(2) Include the date on which the record of the patient ~~IS~~
~~[and]~~be destroyed;~~PROPOSED~~ ~~TO~~

(3) Include a statement that the record or synopsis of the record, if wanted,
[withinmust be retrieved at a designated location 30 days of the proposed date of
destruction] ~~AUTHORIZED;~~~~IF~~ ~~DESTRUCTION~~ ~~OF~~ ~~THE~~ ~~RECORD~~ ~~IS~~ ~~AND~~

~~(4)~~ ~~REQUEST~~ ~~PATIENT’S~~~~THE~~ ~~WRITTEN~~ ~~AUTHORIZATION~~ ~~TO~~ ~~DESTROY~~
~~RECORD.~~~~THE~~

(E) ~~IF~~ ~~AUTHORIZATION~~ ~~FOR~~ ~~THE~~ ~~DESTRUCTION~~ ~~OF~~ ~~A~~ ~~MEDICAL~~ ~~RECORD~~ ~~OR~~
~~X–RAY~~ ~~GIVEN,~~ THE~~LABORATORY~~ ~~OR~~ ~~REPORT~~ ~~IS~~ ~~THE~~ HEALTH CARE PROVIDER
RETRIEVAL:SHALL MAKE THE RECORD OR REPORT AVAILABLE FOR

(1) BY THE PATIENT OR THE PARENT OR GUARDIAN OF THE MINOR
60 DESTRUCTION;PATIENT WITHIN DAYS BEFORE THE ~~PROPOSED~~ DATE OF AND
...
~~[required~~ ~~section]~~~~(1)~~ ~~Forward~~ the notice in thisFORWARD ~~DESCRIBED~~
~~(2)~~ before the destruction or transfer of medical~~IN~~ ~~PARAGRAPH~~ ~~OF~~ ~~THIS~~ ~~SUBSECTION~~
TO:records

~~(I)~~ (1) THE PATIENT; OR

~~(II)~~ (2) FOR PATIENT,A MINOR THE PARENT OR GUARDIAN OF THE
MINOR PATIENT UNLESS THE MEDICAL CARE DOCUMENTED IN THE RECORD WAS
§ 20–102(C) § 20–103(C) ARTICLE; ~~or~~PROVIDED UNDER OR OF THIS
...
[(f)] (G) [Association(1) After consulting with the of Maryland Hospitals and
Systems] MARYLAND HOSPITAL ASSOCIATION,Health the Maryland State Medical
