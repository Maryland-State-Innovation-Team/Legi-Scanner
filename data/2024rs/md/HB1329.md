...
of a supervised individual, without effect on the legal expiration date of theDETENTION
...
of active supervision of the supervised individual for every monthOR HOME DETENTION
...
[and]fees relating to the offense for which earned compliance credits are being accrued;
...
supervision;mandatory release AND

(VI) APPLICABLE,IF HAS BEEN COMPLIANT WITH ANY
SUPERVISION REQUIREMENTS OF A PRIVATE HOME DETENTION MONITORING
AGENCY.

“HOME DETENTION”(4) MEANS MONITORING BY A PRIVATE HOME
TITLE 20, SUBTITLE 1DETENTION MONITORING AGENCY LICENSED UNDER OF THE
...
on the recommendation of the Division of Parole and Probation for earnedDETENTION
...
of supervision DETENTION, the Division shall place the individual onOR HOME
abatement.
...
has been completely reduced as a result of earned compliance credits shallDETENTION
...
(D) ON DIVISION PAROLE PROBATION,REQUEST BY THE OF AND THE
...
INDIVIDUAL’SSHALL FORWARD A REPORT OF THE COMPLIANCE DURING THE
PERIOD.MONITORING

(E) A (D) SECTION, MINIMUM,REPORT UNDER SUBSECTION OF THIS AT A
INCLUDE:SHALL
...
PERIOD,DURING THE MONITORING EVEN IF THE INFRACTION DID NOT RESULT IN A
DIVISION PAROLE PROBATIONREPORTED VIOLATION TO THE OF AND OR THE
...
DIVISION PAROLE PROBATION RELEVANT.OF AND DETERMINES IS
