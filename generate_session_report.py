  ...
  <header class="header animate-in" style="animation-delay:0s;opacity:0">
    ...
    <div style="display:flex;justify-content:space-between;align-items:flex-start;gap:2rem;">
      ...
      <a href="https://innovation.maryland.gov" target="_blank" rel="noopener"
         style="flex-shrink:0;display:flex;align-items:center;gap:0.6rem;
                margin-top:0.25rem;text-decoration:none;opacity:0.9;transition:opacity 0.15s;"
         onmouseover="this.style.opacity='1'" onmouseout="this.style.opacity='0.9'"
      >
        <span style="font-family:'Courier Prime',monospace;font-size:0.65rem;letter-spacing:0.15em;
                     text-transform:uppercase;color:var(--text-muted)">Built by</span>
